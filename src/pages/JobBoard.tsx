  ...
  const jobs = [
    {
      ...
      type: 'Full-time',
      posted: '2 days ago',
      description: 'We are seeking an experienced paralegal to join our litigation team. The ideal candidate will have strong research and writing skills.',
      requirements: [
    ...
    },
    {
      ...
      type: 'Full-time',
      posted: '5 days ago',
      description: 'Remote legal assistant position supporting our corporate law practice. Perfect for organized individuals with attention to detail.',
      requirements: [
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-20">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h1 className="text-2xl font-bold text-gray-900">Smith & Justice LLP</h1>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Discover opportunities to grow your legal career with us</p>
        </div>
        ...
        <section className="mt-16 bg-white rounded-lg p-8 shadow-sm">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-900 mb-2">Competitive Benefits</h4>
              <p className="text-sm text-gray-600">Comprehensive health coverage and retirement plans</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mx-auto mb-4">
                <span className="text-blue-600 font-bold text-xl">⚖</span>
              ...
              <p className="text-sm text-gray-600">Flexible schedules and supportive work environment</p>
            </div>
          </div>
        </section>
      </main>
